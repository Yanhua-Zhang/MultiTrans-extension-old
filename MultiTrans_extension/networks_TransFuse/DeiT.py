...
class DeiT(VisionTransformer):
    ...
    def forward(self, x):
        ...
        #     # print(x.size())
        #     # print(pe.size())
        #     pe = F.interpolate(pe, x.shape[2:], mode='bilinear', align_corners=True)
        #     x = x.squeeze(1)
        #     pe = pe.squeeze(1)
        #     # print(x.size())
        #     # print(pe.size())
...
def deit_small_patch16_224(pretrained=False, **kwargs):
    ...
    if pretrained:
        ckpt = torch.load('/home/zhangyanhua/Code_python/model_pretrained/deit_small_patch16_224-cd65a155.pth')
...
def deit_base_patch16_224(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        ckpt = torch.load('/home/zhangyanhua/Code_python/model_pretrained/deit_base_patch16_224-b5f2ef4d.pth')
        model.load_state_dict(ckpt['model'], strict=False)
...
def deit_base_patch16_384(pretrained=False, **kwargs):
    ...
    model.default_cfg = _cfg()
    if pretrained:
        ckpt = torch.load('/home/zhangyanhua/Code_python/model_pretrained/deit_base_patch16_384-8de9b5d1.pth')
